...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget _createImage(){
    return Container(
      child: Image.network("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTApDp2-1aGGyF8dztJEmCskJMnpPXSEv0Yrbepev4oRfT4p0RoBGdfj-RreFhD6P7DhaM&usqp=CAU"),
    );
  }
